  ...
  Garden.prototype= {
    ...
    initialize : function(width, height, size)  {
      ...
      for( i=0; i<this.num_stars; i++ )  {
        this.stars.push( Math.floor( Math.random()*(width+2000)  ) );
        this.stars.push( Math.floor( Math.random()*(height-500)) );
      }
    },
...
var time;
    ...
    function init(images) {
        ...
        garden= new Garden();
        garden.initialize(canvas.width, canvas.height, 1000);
